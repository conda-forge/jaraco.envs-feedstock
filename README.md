...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jaraco.envs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8760&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jaraco.envs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jaraco.envs` can be installed with:

```
conda install jaraco.envs
```

It is possible to list all of the versions of `jaraco.envs` available on your platform with:
